...
- Busca combinando nome, marca e categoria, ou por código de barras digitado ou lido pela câmera, com paginação e filtros na URL.
...
| `src/features/barcode` | Leitura de código de barras pela câmera (nativo ou ZXing) |
