...
describe("AdminDashboard", () => {
  ...
  it("mostra os indicadores com a meta e o estado de cada um", async () => {
    ...
    expect(container.querySelector(".healthStrip")?.textContent).toContain("1 alerta ativo");
    expect(container.querySelector('[aria-label="Alertas ativos"]')?.textContent).toBe("Erros 5xx 3 de 30 requisições. Limite: < 5%.");
